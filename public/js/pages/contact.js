// Unigram — Contact Us / Grievance (placeholder)
  ...
  return 
    <div class="legal-page">
      ...
      <div class="legal-header">
        ...
        <h1 class="legal-title">Contact Us / Grievance</h1>
        <p class="legal-sub">Reach out to the Unigram team or file a grievance.</p>
      </div>
