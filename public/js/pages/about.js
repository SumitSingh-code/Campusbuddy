// Unigram — About Unigram (placeholder)
  ...
  return 
    <div class="legal-page">
      ...
      <div class="legal-header">
        <div class="legal-icon">&#x2139;&#xFE0F;</div>
        <h1 class="legal-title">About Unigram</h1>
        <p class="legal-sub">Learn about Unigram — who built it and why.</p>
      </div>
      <div class="legal-body">
        <div class="legal-placeholder">
          <p>Content coming soon.</p>
          <p>This page is under preparation. Check back later.</p>
        </div>
      </div>
    </div>
  ;
